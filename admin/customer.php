...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td class='id'> " . $row['lname'] . "</td>";
    echo "<td>" . $row['email'] . "</td>";
    // echo "<td>" . $row['password'] . "</td>";
  
    echo "<td class='edit'><a href='update-customer.php?id=" . $row['id'] . "'><i class='fa fa-edit'></i></a></td>";

    echo "<td class='delete'><a href='delete-customer.php?id=" . $row['id'] . "'><i class='fa fa-trash-o'></i></a></td>";
    echo "</tr>";
}
?>
